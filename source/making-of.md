...
We now have a Middleman project that can get the relevant data from the Github API and generate RailsVault. Next step is to make sure RailsVault stays up to date.
