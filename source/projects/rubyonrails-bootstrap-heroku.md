---
title: Rails 4 Starter App
repo: HighQualityCode/RubyOnRails-Bootstrap-Heroku
homepage: https://github.com/HighQualityCode/RubyOnRails-Bootstrap-Heroku
language: Ruby
license:
templates: Slim
description: A starter application based on Ruby 2.4, Rails 4.2 and Bootstrap for Sass 3, deployable on Heroku
---
