---
title: Niklick
repo: PetrNikolas/niklick
homepage: https://github.com/PetrNikolas/niklick
language: Ruby
license:
templates: ERB
description: Versioned API solution template for hipsters! (Ruby, Ruby on Rails REST API, GraphQL, token based authentication, emails sending, delayed jobs, Postgress DB)
---
